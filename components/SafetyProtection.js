...
const styles = StyleSheet.create({
  ...
  title: { color: "#1C1C1E", fontWeight: "700", fontSize: 15 },
  subtitle: { color: "#666", fontSize: 12, marginTop: 4, lineHeight: 18 },
  analysis: { color: "#555", fontSize: 11, marginTop: 5 },
  indicators: { flexDirection: "row", gap: 8, marginTop: 14 },
  indicator: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  dotActive: { backgroundColor: "#22A06B" },
  dotProcessing: { backgroundColor: "#E59B16" },
  dotAlert: { backgroundColor: "#D82D2D" },
  indicatorText: { color: "#555", fontSize: 10, flex: 1 },
  button: {
  ...
  alertButton: { backgroundColor: "#D82D2D", shadowColor: "#D82D2D" },
  buttonText: { color: "#FFF", fontWeight: "700" },
  error: { color: "#D82D2D", fontSize: 12, marginTop: 8 },
});
