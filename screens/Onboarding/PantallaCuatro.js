...
export default function PantallaCuatro() {
...
const [fontsLoaded] = useFonts({
  ...
  return (
    <View style={styles.container}>
      <Image source={require("../../assets/images/image04.png")} style={styles.image} resizeMode="contain" />
      <View style={styles.separator} />
      <View style={styles.content}>
        <Text style={styles.title}>Domicilios rápidos y seguros con Yebo 📦</Text>
        <Text style={styles.subtitle}>
        De la tienda a tu puerta con solo un clic.
        </Text>
