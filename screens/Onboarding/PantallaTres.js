...
const [fontsLoaded] = useFonts({
  ...
  return (
    <View style={styles.container}>
      <Image source={require("../../assets/images/ImagenInicial.png")} style={styles.image} resizeMode="contain" />
      <View style={styles.separator} />
      <View style={styles.content}>
        <Text style={styles.title}>Tu pedido, en camino con Yebo 🚀</Text>
        <Text style={styles.subtitle}>
        Entrega rápida, confiable y sin complicaciones.
        </Text>

        {/* Botón para ir a la siguiente pantalla */}
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("PantallaCuatro")}>
